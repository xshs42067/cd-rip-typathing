...
<main class="container">
    ...
    <div class='stat-card'><h3>Total Artists</h3><p><?php echo $total_artists; ?></p></div>
    <div class='stat-card'><h3>Total Albums</h3><p><?php echo $total_albums; ?></p></div>
    <div class='stat-card'><h3>Total Songs</h3><p><?php echo $total_songs; ?></p></div>
    <div class='stat-card'><h3>Average Albums per Artist</h3><p><?php echo round($avg_albums, 2); ?></p></div>
    <div class='stat-card'><h3>Average Songs per Album</h3><p><?php echo round($avg_songs, 2); ?></p></div>
    </div>

    <!-- count artists!!!! using GROUP BY and COUNT -->
    <section class='stats-section'>
    <h2>Albums per Artist</h2>
    <p class='section-desc'>See how many albums each artist has in your collection, sorted by the most prolific artists first.</p>
    <?php
    ...
    <p class='section-desc'>Discover which albums have the most tracks, ordered from largest to smallest collections.</p>
    <?php
